...
function addTransaction(source, amount){
    ...
    addTransactionDOM(transaction.id, source, amount, transaction.time); //Include trasaction DOM
}
...
form.addEventListener("submit", event => {
    ...
    //if condition for empty trasaction
    ...
    //end of if condition for empty trasaction
...
//Everytime we load call the function
function init(){
    updateStatistics();
    getTransaction();
}
...
init();
//End Of Everytime we load call the function